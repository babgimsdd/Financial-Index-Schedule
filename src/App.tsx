...
const initialFinanceData: FinanceState = {
  indices: [
  ...
  futures: [
    { symbol: "ES=F", name: "S&P 500 선물", price: 5612.50, change: 12.50, changePercent: 0.22, high: 5625.00, low: 5590.00 },
    { symbol: "NQ=F", name: "나스닥 100 선물", price: 18345.75, change: 85.50, changePercent: 0.47, high: 18400.00, low: 18210.00 },
    { symbol: "YM=F", name: "다우 30 선물", price: 39512.00, change: -24.00, changePercent: -0.06, high: 39600.00, low: 39450.00 },
    { symbol: "NK=F", name: "니케이 225 선물", price: 40920.00, change: 120.00, changePercent: 0.29, high: 41000.00, low: 40750.00 },
    { symbol: "GC=F", name: "골드 선물", price: 2385.40, change: 15.20, changePercent: 0.64, high: 2395.00, low: 2370.00 },
    { symbol: "CL=F", name: "크루드 오일 선물", price: 82.15, change: -0.45, changePercent: -0.54, high: 83.20, low: 81.80 },
    { symbol: "NG=F", name: "천연가스 선물", price: 2.34, change: 0.08, changePercent: 3.54, high: 2.40, low: 2.25 }
  ],
  forex: [
  ...
  economicEvents: [
    { weekday: 1, time: "17:30", indicator: "유로존 Sentix 투자자 신뢰지수", importance: "medium", previous: "-0.3", forecast: "1.0", actual: "1.2" },
    { weekday: 1, time: "23:00", indicator: "미국 ISM 제조업 구매관리자지수 (PMI)", importance: "high", previous: "48.5", forecast: "48.8", actual: "48.5" },
    { weekday: 2, time: "23:00", indicator: "미국 CB 소비자신뢰지수", importance: "high", previous: "100.4", forecast: "100.0", actual: "100.3" },
    { weekday: 3, time: "21:30", indicator: "미국 소비자물가지수 (CPI) (전년 대비)", importance: "high", previous: "3.0%", forecast: "2.9%", actual: "3.0%" },
    { customDay: 29, time: "03:00", indicator: "미국 FOMC 기준금리 결정 발표", importance: "high", previous: "5.50%", forecast: "5.50%", actual: "5.50%" }
  ],
  marketCalendar: [
...
export default function App() {
  ...
  const [data, setData] = useState<FinanceState>(initialFinanceData);
